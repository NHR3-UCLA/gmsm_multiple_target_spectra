...
def MatrixElementRep_Larger(a,b,BenchmarkValue,ReplValue,my_device):
    ...
    #Define the kernel
    prg = cl.Program(ctx, """
    __kernel void MatrixElementRepLarger(
    ...
    prg.MatrixElementRepLarger(queue, a.shape, None, a1, b1,np.float32(BenchmarkValue),np.float32(ReplValue), c1)
    c = np.empty_like(a)
